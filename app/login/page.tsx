        ...
        <div className="mx-auto w-full max-w-sm">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div className="space-y-2">
              ...
              <Input id="email" type="email" placeholder="student@school.edu" required className="h-11 rounded-xl bg-slate-50 border-slate-200" value={email} onChange={e => setEmail(e.target.value)} />
            </div>
            <div className="space-y-2">
